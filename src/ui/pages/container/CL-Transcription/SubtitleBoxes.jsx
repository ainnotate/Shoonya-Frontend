...
export default memo(
  function ({ render, currentTime, duration, allowOverlap = true, onToggleOverlap }) {
    ...
    return (
      <div className={classes.parentSubtitleBox} ref={$blockRef}>
        ...
        <div style={{ 
          ...
          right: '5px', 
          padding: '2px 8px',
          backgroundColor: allowOverlap ? 'rgba(0, 153, 51, 0.7)' : 'rgba(153, 51, 0, 0.7)',
          color: 'white',
          borderRadius: '4px',
          fontSize: '12px',
          zIndex: 1000
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: isLocked ? "2px solid #f44336" : undefined,
                  background: isLocked ? 
